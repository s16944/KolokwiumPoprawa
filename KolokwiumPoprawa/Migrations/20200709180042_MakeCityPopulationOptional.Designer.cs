...
namespace KolokwiumPoprawa.Migrations
{
    ...
    [Migration("20200709180042_MakeCityPopulationOptional")]
    partial class MakeCityPopulationOptional
    {
            ...
            modelBuilder.Entity("KolokwiumPoprawa.Models.ArtMovement", b =>
                {
                    b.HasOne("KolokwiumPoprawa.Models.Artist", "MovementFounder")
                        .WithOne("FoundedArtMovement")
                        .HasForeignKey("KolokwiumPoprawa.Models.ArtMovement", "IdMovementFounder")
